...
<CustomImage src={clone} alt="clone" />
...
<CustomImage src={branch} alt="branch" />
...
<CustomImage src={commit1} alt="commit1" />

<CustomImage src={commit2} alt="commit2" />
