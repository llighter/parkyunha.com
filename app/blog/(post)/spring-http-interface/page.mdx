...
import projectMap from "./project-map.png";
import articleServiceGetAllArticles from "./article-service-get-all-articles.png";
import serverToServer from "./server_to_server.jpeg";
...
export const metadata = {
  ...
  image: "/images/hero/server_to_server.jpeg",
  imageDescription:
    "HTTP 통신을 통해 서버와 서버 간에 데이터를 주고 받을 수 있다.",
};

<PostHeader metadata={metadata} slug="spring-http-interface" />
<HeroImage
  src={serverToServer}
  alt="serverToServer"
  caption="HTTP 통신을 통해 서버와 서버 간에 데이터를 주고 받을 수 있다."
/>
...
<AppleImage
  src={articleServiceGetAllArticles}
  alt="get all articles"
  caption="content-service에서 article-service로부터 article 목록을 조회하는 요청"
  inline={true}
/>
